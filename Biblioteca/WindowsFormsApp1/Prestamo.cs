...
namespace WindowsFormsApp1
{
    public partial class Prestamo : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (registro.Read())
            {
                label14.Text= registro["Lib_Id"].ToString();// guardo id libro
        ...
        private void CalcularDias()
        {
            if (ValidarFecha()) {
                ...
                MessageBox.Show("Fecha Invalida, No puedes seleccionar una fecha anterior,ni futura para el retiro del libro", "Error de Ingreso", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        {
            conexion.Open();
            string sql = "SELECT Pres_Id,Pres_Fecha_Entrega,Pres_Fech_Dev,Pres_Soc_Id,Soc_Dni,Soc_Nombre,Soc_Apellido,Soc_Telef,Lib_Titulo,Aut_Nombre,Edit_Nombre,stock_cantidad,stock_total,Usu_Id,Usu_Nombre FROM prestamo  " +
                "JOIN socio ON Soc_Id = Pres_Soc_Id " +
        ...
        private void buttonGrabar_Click(object sender, EventArgs e)
        {
            ...
            if (!prestamosOtorgados())
            {
                ...
                MessageBox.Show("Ya paso el limite de 3 prestamos por socio ", "Error de Ingreso", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            ...
            else
            {
                ...
                MySqlCommand comando = new MySqlCommand(sql, conexion);
                comando.Parameters.Add("@fechentrega", MySqlDbType.Date).Value = dateTimePicker1.Value.Date;
                ...
                if (registrop.Read())
                {
                    ...
                    idprestamo = registrop["PresDet_Id"].ToString();// tengo guardado el id del prestamo
